...
/**
 * Generate Postman Collection for BOMEQP API
 * Run: php generate_postman_collection.php
 */
...
$publicEndpoints = [
    ...
    createRequest('Verify Email', 'GET', '/auth/verify-email/:token', null),
    createRequest('Verify Certificate', 'GET', '/certificates/verify/:code', null)
];

$collection['item'][] = [
    'name' => 'Public Endpoints',
    'item' => $publicEndpoints
];
...
$collection['item'][] = [
    'name' => 'ACC Admin',
    'item' => $accAdminEndpoints
];

// Training Center Endpoints
$trainingCenterEndpoints = [
    [
        'name' => 'Dashboard',
        'item' => [
...
$collection['item'][] = [
    'name' => 'Instructor',
    'item' => $instructorEndpoints
];

// Write to file
file_put_contents('BOMEQP_Postman_Collection.json', json_encode($collection, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES));

echo "Postman collection generated successfully!\n";
echo "File: BOMEQP_Postman_Collection.json\n";
echo "Import this file into Postman to use all APIs.\n";
